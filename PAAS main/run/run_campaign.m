...
[b_abs,b_abs_highres,time,TimeStart,TimeEnd,time_highres,laser_wavelength] = ...
...
% Remove interlock failures
b_abs = apply_interlock_filter(b_abs,time,cfg);
